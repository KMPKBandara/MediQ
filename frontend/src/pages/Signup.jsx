          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <p className="mt-5 text-textColor text-center">
                ...
                <Link
                  to="/login"
                  className="text-primaryColor font-medium mi-1"
                >
                  Login
                </Link>
              </p>
...
const Signup = () => {
  const [selectedFile, setSelectedFile] = useState(null);
  const [previewURL, setPreviewURL] = useState(""); // Corrected typo: setpreviewURL -> setPreviewURL
  const [loading, setLoading] = useState(false);
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    photo: selectedFile, // This will be null initially, updated after upload
    gender: "",
    role: "patient",
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center justify-between">
                <label
                  htmlFor="role-select" // Added htmlFor for accessibility
                  className="text-headingColor font-bold text-[16px] leading-7"
                >
                  Are you a:
                  <select
                    id="role-select" // Added id for htmlFor
                    name="role"
                    value={formData.role}
                    onChange={handleInputChange}
                    className="text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none"
              ...
              <div className="mt-7">
                ...
                >
                  {loading ? (
                    <HashLoader size={35} color="#ffffff" className="mx-auto" /> // Centered loader
                  ) : (
                    "Sign Up"
                  )}
                </button>
